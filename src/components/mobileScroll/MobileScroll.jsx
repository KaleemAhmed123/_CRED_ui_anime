      ...
      <div className="moving-text-wrapper">
        {scrollData.map((screen, i) => (
          <div className="moving-text">
            {/* passing from child to parent when child changes parent gets changed */}
            <ScreenText screen={screen} setCurrentImg={setCurrentImg} i={i} />
          </div>
        ))}
      </div>
      {/* right */}
      <div className="mobile-image-wrapper non-mobile">
        <div className="mobile-body-faker ">
          <div className="mobile-image-screen flex center">
            <img
              src={scrollData[currentImg].mobile_img}
              className="current-image slide-in-right"
